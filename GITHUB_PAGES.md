...
The [published website](https://the-ai-alliance.github.io/deep-research-agent-in-finance/).
...
* The `--baseurl` flag effectively supports the simple URL, `localhost:$JEKYLL_PORT`. (Without it, the URL would be `localhost:$JEKYLL_PORT/The-AI-Alliance/deep-research-agent-in-finance/`.)
...
Finally, if you are still stuck, please [post an issue](https://github.com/The-AI-Alliance/deep-research-agent-in-finance/issues) to get help.
