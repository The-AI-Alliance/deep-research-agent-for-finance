...
1. [diabetes_report-1.md](diabetes_report-1.md). The earliest, with good information, but surpassed by the next two.
1. [diabetes_report-2.md](diabetes_report-2.md). Close to the quality of #3.
1. [diabetes_report-3.md](diabetes_report-3.md). The best report.
