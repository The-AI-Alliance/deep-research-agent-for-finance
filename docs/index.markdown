...
| **Last Update** | V0.1.0, 2025-07-09 |

> **Tip:** Use the search box at the top of this page to find specific content.

Welcome to the **The AI Alliance**: **Example App for AI in Finance**. 

Please join us! See our [contributing]({{site.baseurl}}/contributing) page for details.

> **TODO:** This is a work-in-progress website for the Example App for AI in Finance.
...
* [Project GitHub Repo](https://github.com/The-AI-Alliance/ai-in-finance-sample-app){:target="repo"}
